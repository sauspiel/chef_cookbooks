...
default.nginx[:gzip_types] = [ "text/plain", "text/css", "application/javascript", "application/x-javascript", "text/xml", "application/xml", "application/xml+rss", "image/svg+xml", "text/javascript" ]
default.nginx[:version] = "1.0.14-1~squeeze"
default.nginx[:expires][:enabled] = true
default.nginx[:expires][:regex] = '^/(application|javascripts|stylesheets|images|sprockets|versioned_assets|favicon)[/\.]'
